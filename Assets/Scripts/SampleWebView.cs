...
public class SampleWebView : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        webViewObject.SetMargins(Mathf.RoundToInt(Screen.width / 60), Mathf.RoundToInt(Screen.height / 50), Mathf.RoundToInt(Screen.width / 60), Mathf.RoundToInt(Screen.height / 11.5f));
